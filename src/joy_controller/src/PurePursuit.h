...
public:
    PurePursuit(point target_coordinates[], uint target_num, double look_ahead_dist, double initial_x = 0.0, double initial_y = 0.0, double initial_theta = 0.0, double finish_dist = 0.1);
    double compute_angvel(double x, double y, double theta);
